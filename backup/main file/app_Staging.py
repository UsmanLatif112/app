...
def run_script():
    ...
    Piroty_token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..v_QFqImVXcMdx6kKf1WVa5ksixygJIZ3XaVQyFcijG4"
    # id = "19233"
    id = f'{campaign_idd}'
    # ================================================
    ...
    Keyword_new = f"CHatbotKings{id}016"

    # Client name which is used to create new client

    Client_Name_New = f"CHatbotKings{id}013"
